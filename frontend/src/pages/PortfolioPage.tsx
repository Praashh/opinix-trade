...
//           <TradeStatus image={""} title={"will india win the 2nd test against bangladesh"} returns={0} investment={0} />
...
const PortfolioPage = () => {
  ...
  return (
    <div className="w-screen h-screen bg-bg">
      ...
      <div className="flex flex-col gap-5 items-center"> {/* Center the TradeStatus */}
        <TradeStatus 
          image="https://via.placeholder.com/150" 
          title="Will India win the 2nd test against Bangladesh" 
          returns={0} 
          investment={0} 
        />
      </div>
